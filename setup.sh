...
cd /var/www/html && sudo wget http://sourceforge.net/projects/flow3/files/latest/download -O /var/www/html/flow3.tar.bz2 && sudo tar xjf flow3.tar.bz2 --strip-components=1
